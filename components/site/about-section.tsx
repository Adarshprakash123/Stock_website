        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              We Transform Beginners Into Skilled Traders
            </h2>
            <p className="text-gray-600 mb-6">
              Founded in 2018, TradePro has been at the forefront of trading
              education, helping thousands of students achieve financial
              independence through strategic market trading.
            </p>
            <p className="text-gray-600 mb-6">
              Our expert instructors bring decades of real-world trading
              experience to provide you with practical, actionable strategies
              that work in today's markets.
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Industry-leading analysis and insights
                  </p>
                </div>
              </div>
